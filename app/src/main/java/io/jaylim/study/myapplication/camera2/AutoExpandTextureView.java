...
/**
 * A auto resizable {@link TextureView}.
 * <p>
 * Created by jaylim on 11/22/2016.
 */

public class AutoExpandTextureView extends TextureView {
    private int mRatioWidth = 0;
    private int mRatioHeight = 0;

    public AutoExpandTextureView(Context context) {
        this(context, null);
    }

    public AutoExpandTextureView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoExpandTextureView(Context context, AttributeSet attrs, int defStyle) {
     ...
     *
     * * AT_MOST typically means the layout_width or layout_height calue was set to match_parent
